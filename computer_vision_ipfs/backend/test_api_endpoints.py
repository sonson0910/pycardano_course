...
def test_create_did():
    ...
    try:
        ...
        response = requests.post(f"{BACKEND_URL}/did/create", json=payload, timeout=10)
...
def test_register_did(did_id):
    ...
    try:
        ...
        response = requests.post(
            f"{BACKEND_URL}/did/{did_id}/register", json={}, timeout=10
        )
...
def test_verify_did(did_id):
    ...
    try:
        ...
        response = requests.post(
            f"{BACKEND_URL}/did/{did_id}/verify", json={}, timeout=10
        )
